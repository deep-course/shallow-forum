          ...
          new HtmlWebpackPlugin(
            Object.assign(
              {},
              {
                ...
                chunks: [key],
                template: template,
                filename: `${isEnvProduction ? 'page/' : ''}${key}.html`
              },
              isEnvProduction
                ? {
                    minify: {
  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        '@api': path.resolve(__dirname, '../src/config/api.js'),
      ...
      new ManifestPlugin({
        ...
        generate: (seed, files, entrypoints) => {
          ...
          Object.keys(entrypoints).forEach(key => {
            entrypointFiles.push(...entrypoints[key].filter(fileName => !fileName.endsWith('.map')))
          })
